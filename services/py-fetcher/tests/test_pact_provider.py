...
class TestPyFetcherProvider:
    ...
    def test_against_api_server_contract(self, provider_service, mocker):
        ...
        def arxiv_service_available():
            ...
            mocker.patch(
                "src.services.arxiv_service.arxiv_fetcher.fetch", side_effect=mock_fetch
            )
            return True
        ...
        def arxiv_service_receives_an_invalid_article_fetch_request():
            """Setup for POST /api/v1/articles with bad data. No mock needed."""
            return True
        ...
        provider_states = {
            ...
            "arxiv service receives an invalid article fetch request": arxiv_service_receives_an_invalid_article_fetch_request,
        }
